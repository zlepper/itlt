    ...
    private static void migrateSameFormat(final UnmodifiableCommentedConfig oldConfig, final Set<String> blacklist) {
        ...
        for (final Map.Entry<String, Object> entry : oldConfig.valueMap().entrySet()) {
            ...
            if (value instanceof UnmodifiableCommentedConfig) {
                final UnmodifiableCommentedConfig valueAsMap = (UnmodifiableCommentedConfig) value;
    ...
    public static void migrate(String from, final String to, final UnmodifiableCommentedConfig oldConfig) {
        switch (from) {
            ...
            case "2.0.0": {
                ...
                final HashSet<String> ignoreList = new HashSet<>(
                        Arrays.asList("enableCustomWindowTitle", "customWindowTitleText", "enableUsingAutodetectedDisplayName",
