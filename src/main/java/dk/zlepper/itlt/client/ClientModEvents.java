    ...
    public static void clientInit(final FMLClientSetupEvent event) {
        ...
        if (ClientConfig.enableCustomWindowTitle.get()) {
            ...
            if (mcVersion.equals("1.15.2")) {
                ...
                // use a fixed %mc string if running on 1.15.1
            ...
            if (!customWindowTitle.isEmpty()) {
                if (mcVersion.equals("1.15.2")) {
                    ...
                    mcInstance.getMainWindow().func_230148_b_(customWindowTitle);
                } else {
                    GLFW.glfwSetWindowTitle(mcInstance.getMainWindow().getHandle(), customWindowTitle);
                }
            }
        }
